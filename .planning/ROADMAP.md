...
**Plans**: 3 plans
- [ ] 20-01-PLAN.md — Wave 1: fix the test-debt (snapshot-prefetch count drift D-05, U7 chat-watchdog wall-clock flake HYG-03, the 7 env-dependent safety-CLI harness failures D-06) so the full sweep is honestly green
