...
**Plans**: 5 plans
Plans:
- [ ] 19-01-PLAN.md — Wave 1: safety primitive — migration 0019 (additive action_cards_flag) + degrade-to-OFF flag repo (inverted polarity, NOT version-scoped) + runtime-read swap at editor.ts:387 / situation-room.ts (inert at default OFF)
