...
// employee (from chat.roster) and the selected topic (from chat.topics). It
// adds NO new worker handler: it is a read-only summary of the active
// conversation context per the sketch's right rail.
//
  ...
  return (
    <aside className="ctx" data-clarity-region="context-rail">
      ...
      <p className="ctx-empty">
        Task ownership view arrives with the Situation Room cross-link.
      </p>
