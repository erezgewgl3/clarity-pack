...
// ---- Task 3 — manifest contract test (drift guard) ------------------------
// Added in Task 3: the manifest tool[] declaration must stay locked to the
// worker's SUBMIT_COMPILE_RESULT_TOOL so they cannot drift apart silently.
